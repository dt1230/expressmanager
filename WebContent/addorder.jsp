...
<body style="background-image: url(image/background.jpg);-moz-background-size:100% 100%; background-size:100% 100%;">
	<div style="color:red">
	<h3 style="text-align: center; margin-top: 15px;">请填写快递单：</h3>
	...
	<div class="demo">
		...
		<input style="border-color:red" type="text"
			class="cityinput"  id="fromlocation"
			placeholder="请输入寄发地"> <label for="fromlocation">寄发详细地址</label>
		<input style="border-color:red" type="text" class="cityinput" name="fromdetal" id="fromdetal"
		...
		<input style="border-color:red" type="text"
			...
			<input style="border-color:red" type="text" class="cityinput"
	...
	<div class="demo">
		...
		<label for="tolocation">收件城市</label> <input style="border-color:red" type="text"
			class="cityinput" id="tolocation"
			placeholder="请输入目的地"> <label for="fromlocation">收件人详细地址</label>
		<input style="border-color:red" type="text" class="cityinput" name="todetal" id="todetal"
			 placeholder="请输入详细地址"><br><span id="tolabel" style="color: red;"></span>
		<br><span id="tolabel1" style="color: red;"></span>
		<br> <label for="fromlocation">收件人</label> <input style="border-color:red" type="text"
			class="cityinput" name="toname" id="toname" placeholder="请输入收件人"> <label
			for="fromlocation">收件人电话</label> <input style="border-color:red" type="text" class="cityinput"
	...
	<div class="demo">
		<center>
			<button onclick="fmsub()"
				style="color: #fff; background-color: #4B95FF; border-color: #2a75fe; border-radius: 5px; height: 45px; width: 100%">提交快递订单</button>
		</center>
	</div>
	</div>
	<br><br><br><br><br>
